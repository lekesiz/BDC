...
# AIAnalysis ve HumanVerification modelleri henüz mevcut olmayabilir
# Bu modelleri sonradan ekleyeceğiz veya içe aktaracağız
# from app.models import AIAnalysis, HumanVerification

# Geçici olarak bu sınıfları tanımlamadan önce kontrol etmek gerekir
try:
    from app.models.monitoring import AIAnalysis, HumanVerification
except ImportError:
    # Modeller henüz taşınmadıysa, geçici sınıflar oluşturalım
    class AIAnalysis:
        pass
