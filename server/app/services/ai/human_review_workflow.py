...
# Geçici sınıflar, taşınmamış modeller için
class Notification:
    pass
...
# Henüz taşınmamış servisleri temsil eden geçici sınıflar
class NotificationService:
    def create_notification(self, user_id, notification_type, title, message, data, db):
