...
import { Badge } from '../ui/badge';import { useTranslation } from "react-i18next";
const WidgetLibrary = ({ darkMode }) => {const { t } = useTranslation();
      ...
      'bg-white dark:bg-gray-800 border-gray-200 dark:border-gray-700 hover:border-gray-300 dark:hover:border-gray-600'}
        ...
        'bg-gray-100 dark:bg-gray-700'}
            ...
            <div className="flex-1">
              ...
              <p className="text-xs text-gray-500 dark:text-gray-400">{t("components.drag_to_add")}
      ...
      <div className="p-4 border-b border-gray-200 dark:border-gray-700">
        ...
        <Tabs value={activeCategory} onValueChange={setActiveCategory}>
          <TabsList className="grid grid-cols-3 gap-1">
            <TabsTrigger value="all" className="text-xs">{t("components.all")}</TabsTrigger>
            <TabsTrigger value="charts" className="text-xs">{t("components.charts")}</TabsTrigger>
            <TabsTrigger value="kpis" className="text-xs">KPIs</TabsTrigger>
          </TabsList>
          <TabsList className="grid grid-cols-3 gap-1 mt-1">
            <TabsTrigger value="tables" className="text-xs">{t("components.tables")}</TabsTrigger>
            <TabsTrigger value="content" className="text-xs">{t("components.content")}</TabsTrigger>
            <TabsTrigger value="advanced" className="text-xs">{t("components.advanced")}</TabsTrigger>
          </TabsList>
        </Tabs>
      </div>
