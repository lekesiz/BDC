      ...
      {results && (
        <div className="space-y-4">
              ...
              <div className="space-y-3">
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-sm text-gray-600">
                    {getPlagiarismSeverity(results.plagiarism_percentage).label} similarity detected
                  </p>
                </div>
              </div>
          ...
          {results.sources && results.sources.length > 0 && (
            <Card>
              <CardHeader>
                <CardTitle>Matched Sources ({results.sources.length})</CardTitle>
              </CardHeader>
              <CardContent>
                <div className="space-y-3">
          ...
          {results.ai_detection?.details && (
            <Card>
              <CardHeader>
                <CardTitle>AI Detection Details</CardTitle>
              </CardHeader>
              <CardContent>
                <div className="space-y-3">
