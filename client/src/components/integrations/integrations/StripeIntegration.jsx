...
const StripeIntegration = ({ integration, onBack }) => {const { t } = useTranslation();
  ...
  <>
        ...
        <div className="p-6">
          <div className="flex items-center justify-between mb-4">
            ...
            <Badge variant="success">
                  <CheckCircle className="w-3 h-3 mr-1" />{t("components.charges_enabled")}

            </Badge> :

            <Badge variant="danger">
                  <AlertCircle className="w-3 h-3 mr-1" />{t("components.charges_disabled")}

            </Badge>
            }
              {accountInfo.payoutsEnabled &&
            <Badge variant="success">
                  <CheckCircle className="w-3 h-3 mr-1" />{t("components.payouts_enabled")}
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="bg-gray-50 rounded-lg p-4">
              <div className="flex items-center justify-between mb-2">
                <p className="text-sm text-gray-600">{t("components.todays_revenue")}</p>
            ...
            <div className="bg-gray-50 rounded-lg p-4">
              <div className="flex items-center justify-between mb-2">
                <p className="text-sm text-gray-600">{t("components.this_month")}</p>
                <DollarSign className="w-4 h-4 text-purple-500" />
              </div>
              <p className="text-2xl font-bold">€{financialStats.revenue.thisMonth.toLocaleString()}</p>
              <p className="text-sm text-green-600">
                +{((financialStats.revenue.thisMonth - financialStats.revenue.lastMonth) / financialStats.revenue.lastMonth * 100).toFixed(1)}{t("components._vs_last_month")}
            </p>
            </div>
            <div className="bg-gray-50 rounded-lg p-4">
              <div className="flex items-center justify-between mb-2">
                <p className="text-sm text-gray-600">{t("components.active_subscriptions")}</p>
                <Users className="w-4 h-4 text-blue-500" />
              </div>
              <p className="text-2xl font-bold">{financialStats.subscriptions.active}</p>
              <p className="text-sm text-gray-500">{financialStats.subscriptions.trial}{t("components.in_trial")}</p>
            </div>
          </div>
        </div>
      </Card>
      ...
      <Card>
        <div className="p-6">
          <h3 className="text-lg font-semibold mb-4">{t("components.accepted_payment_methods")}</h3>
      ...
      <Card>
        <div className="p-6">
          <div className="flex items-center justify-between mb-4">
            <h3 className="text-lg font-semibold">{t("components.products_prices")}</h3>
            <Button variant="primary" size="sm">
              <ShoppingCart className="w-4 h-4 mr-2" />{t("components.add_product")}
          ...
          <div key={product.id} className="flex items-center justify-between p-4 border rounded-lg">
                <div>
                  ...
                  <div className="flex items-center space-x-4 mt-1">
                    ...
                    {product.recurring &&
                <Badge variant="secondary" size="sm">{t("components.recurring")}</Badge>
                }
      ...
      <Card>
        <div className="p-6">
          <div className="flex items-center justify-between mb-4">
            <h3 className="text-lg font-semibold">{t("components.recent_transactions")}</h3>
            <Button variant="ghost" size="sm">
              <BarChart3 className="w-4 h-4 mr-2" />{t("archive-components.view_all")}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <button className="flex items-center p-4 border rounded-lg hover:bg-gray-50 transition-colors">
              ...
              <div className="text-left">
                <p className="font-medium">{t("components.create_payment_link")}</p>
                <p className="text-sm text-gray-500">{t("components.generate_a_payment_link")}</p>
              </div>
            </button>
            <button className="flex items-center p-4 border rounded-lg hover:bg-gray-50 transition-colors">
              <Receipt className="w-5 h-5 text-blue-600 mr-3" />
              <div className="text-left">
                <p className="font-medium">{t("components.send_invoice")}</p>
                <p className="text-sm text-gray-500">{t("components.create_and_send_an_invoice")}</p>
              </div>
            </button>
            <button className="flex items-center p-4 border rounded-lg hover:bg-gray-50 transition-colors">
              <FileText className="w-5 h-5 text-green-600 mr-3" />
              <div className="text-left">
                <p className="font-medium">{t("components.export_reports")}</p>
                <p className="text-sm text-gray-500">{t("components.download_financial_reports")}</p>
              </div>
            </button>
            <button className="flex items-center p-4 border rounded-lg hover:bg-gray-50 transition-colors">
              <Shield className="w-5 h-5 text-orange-600 mr-3" />
              <div className="text-left">
                <p className="font-medium">{t("components.fraud_protection")}</p>
                <p className="text-sm text-gray-500">{t("components.configure_radar_settings")}</p>
              </div>
            </button>
          </div>
        </div>
      ...
      <Alert variant="info">
        ...
        <div>
          <p className="font-medium">{t("components.pci_compliance")}</p>
          <p className="text-sm">{t("components.stripe_handles_all_payment_processing_securely_you")}
