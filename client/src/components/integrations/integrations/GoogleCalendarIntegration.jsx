...
const GoogleCalendarIntegration = ({ integration, onBack }) => {const { t } = useTranslation();
  ...
  <>
        ...
        <Card>
          <div className="p-4">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm text-gray-600">{t("components.total_events")}</p>
                <p className="text-2xl font-bold">342</p>
              </div>
              <Calendar className="w-8 h-8 text-blue-500" />
            </div>
            <p className="text-xs text-gray-500 mt-2">{t("components.synced_today_23")}</p>
          </div>
        </Card>
        <Card>
          <div className="p-4">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm text-gray-600">{t("components.active_calendars")}</p>
                <p className="text-2xl font-bold">2/4</p>
              </div>
              <CheckCircle className="w-8 h-8 text-green-500" />
            </div>
            <p className="text-xs text-gray-500 mt-2">{t("components.selected_for_sync")}</p>
          </div>
        </Card>
        <Card>
          <div className="p-4">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm text-gray-600">{t("components.next_sync")}</p>
                <p className="text-2xl font-bold">12m</p>
              </div>
              <Clock className="w-8 h-8 text-orange-500" />
            </div>
            <p className="text-xs text-gray-500 mt-2">{t("components.every_15_minutes")}</p>
          </div>
        </Card>
      </div>
      {/* Quick Actions */}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <button className="flex items-center p-4 border rounded-lg hover:bg-gray-50 transition-colors">
              ...
              <div className="text-left">
                <p className="font-medium">{t("components.create_event")}</p>
                <p className="text-sm text-gray-500">{t("components.add_a_new_event_to_google_calendar")}</p>
              </div>
            </button>
            <button className="flex items-center p-4 border rounded-lg hover:bg-gray-50 transition-colors">
              <Users className="w-5 h-5 text-green-600 mr-3" />
              <div className="text-left">
                <p className="font-medium">{t("components.import_appointments")}</p>
                <p className="text-sm text-gray-500">{t("components.import_from_bdc_to_google_calendar")}</p>
              </div>
            </button>
            <button className="flex items-center p-4 border rounded-lg hover:bg-gray-50 transition-colors">
              <Video className="w-5 h-5 text-purple-600 mr-3" />
              <div className="text-left">
                <p className="font-medium">{t("components.setup_meet_links")}</p>
            ...
            <button className="flex items-center p-4 border rounded-lg hover:bg-gray-50 transition-colors">
              ...
              <div className="text-left">
                <p className="font-medium">{t("components.configure_sync")}</p>
      ...
      <Card>
        <div className="p-6">
          <h3 className="text-lg font-semibold mb-4">{t("components.available_calendars")}</h3>
          ...
          <div key={calendar.id} className="flex items-center justify-between p-3 border rounded-lg">
                ...
                <div className="flex items-center space-x-2">
                  ...
                  className="mr-2" />
                    ...
                    <span className="text-sm">{t("components.sync_enabled")}</span>
                  </label>
      ...
      <Card>
        <div className="p-6">
          <h3 className="text-lg font-semibold mb-4">{t("components.recent_sync_activity")}</h3>
          <div className="space-y-3">
            {[
