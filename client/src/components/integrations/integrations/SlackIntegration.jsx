...
import {
  ...
  AlertCircle } from
'lucide-react';
const SlackIntegration = ({ integration, onBack }) => {const { t } = useTranslation();
  ...
  <>
        ...
        <div className="p-6">
          <div className="flex items-center justify-between mb-4">
            <div className="flex items-center">
              ...
              <div>
                ...
                <p className="text-sm text-gray-500">{t("components.workspace_id")}{workspace.id}</p>
              </div>
            </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            <div className="text-center p-3 bg-gray-50 rounded-lg">
              ...
              <p className="text-sm text-gray-600">{t("components.members")}</p>
            </div>
            <div className="text-center p-3 bg-gray-50 rounded-lg">
              <p className="text-2xl font-bold">{workspace.channels}</p>
              <p className="text-sm text-gray-600">{t("components.channels")}</p>
            </div>
            <div className="text-center p-3 bg-gray-50 rounded-lg">
            ...
            <div className="text-center p-3 bg-gray-50 rounded-lg">
              ...
              <p className="text-sm text-gray-600">{t("components.files_shared")}</p>
            </div>
          </div>
        </div>
      </Card>
      ...
      <Card>
        <div className="p-6">
          <h3 className="text-lg font-semibold mb-4">{t("components.channel_configuration")}</h3>
                ...
                <Lock className="w-4 h-4 text-gray-400" />
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-500">
                      {channel.members}{t("components.members_")}{channel.type}
                    </p>
                  </div>
                </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <button className="flex items-center p-4 border rounded-lg hover:bg-gray-50 transition-colors">
              ...
              <div className="text-left">
                ...
                <p className="text-sm text-gray-500">{t("components.post_to_any_channel")}</p>
              </div>
            </button>
            <button className="flex items-center p-4 border rounded-lg hover:bg-gray-50 transition-colors">
              <AtSign className="w-5 h-5 text-blue-600 mr-3" />
              <div className="text-left">
                <p className="font-medium">{t("components.direct_message")}</p>
                <p className="text-sm text-gray-500">{t("components.message_a_specific_user")}</p>
              </div>
            </button>
            <button className="flex items-center p-4 border rounded-lg hover:bg-gray-50 transition-colors">
              <Zap className="w-5 h-5 text-yellow-600 mr-3" />
              <div className="text-left">
                <p className="font-medium">{t("components.test_integration")}</p>
            ...
            <button className="flex items-center p-4 border rounded-lg hover:bg-gray-50 transition-colors">
              ...
              <div className="text-left">
                <p className="font-medium">{t("components.sync_users")}</p>
                <p className="text-sm text-gray-500">{t("components.update_user_mappings")}</p>
              </div>
            </button>
          </div>
        </div>
...
import { Lock } from 'lucide-react';import { useTranslation } from "react-i18next";
