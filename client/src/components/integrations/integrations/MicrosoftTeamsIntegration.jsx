...
const MicrosoftTeamsIntegration = ({ integration, onBack }) => {const { t } = useTranslation();
  ...
  <>
        ...
        <Card>
          <div className="p-4">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm text-gray-600">{t("components.active_teams")}</p>
                <p className="text-2xl font-bold">3</p>
              </div>
              <Users className="w-8 h-8 text-purple-500" />
            </div>
            <p className="text-xs text-gray-500 mt-2">{t("components.80_total_members")}</p>
          </div>
        </Card>
        <Card>
          <div className="p-4">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm text-gray-600">{t("components.messages_sent")}</p>
                <p className="text-2xl font-bold">156</p>
              </div>
              <MessageSquare className="w-8 h-8 text-blue-500" />
            </div>
            <p className="text-xs text-gray-500 mt-2">{t("components.today_23")}</p>
          </div>
        </Card>
        <Card>
          <div className="p-4">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm text-gray-600">{t("components.meetings_created")}</p>
                <p className="text-2xl font-bold">48</p>
              </div>
              <Video className="w-8 h-8 text-green-500" />
            </div>
            <p className="text-xs text-gray-500 mt-2">{t("components.this_week_12")}</p>
          </div>
        </Card>
        <Card>
          <div className="p-4">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm text-gray-600">{t("components.active_channels")}</p>
                <p className="text-2xl font-bold">18</p>
              </div>
              <Hash className="w-8 h-8 text-orange-500" />
            </div>
            <p className="text-xs text-gray-500 mt-2">{t("components.with_notifications_6")}</p>
          </div>
        </Card>
      </div>
      {/* Teams Overview */}
      <Card>
        <div className="p-6">
          <h3 className="text-lg font-semibold mb-4">{t("components.connected_teams")}</h3>
              ...
              team.active ? 'bg-purple-100' : 'bg-gray-100'}`
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-500">
                      {team.members}{t("components.members_")}{team.channels} channels
                    </p>
                  </div>
                </div>
      ...
      <Card>
        <div className="p-6">
          <h3 className="text-lg font-semibold mb-4">{t("components.channel_notifications")}</h3>
          <div className="space-y-3">
          ...
          <div key={channel.id} className="flex items-center justify-between p-3 border rounded-lg">
                ...
                className="mr-2" />
                  ...
                  <span className="text-sm">{t("components.send_notifications")}</span>
                </label>
              </div>
          )}
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <button className="flex items-center p-4 border rounded-lg hover:bg-gray-50 transition-colors">
              ...
              <div className="text-left">
                <p className="font-medium">{t("components.send_announcement")}</p>
                <p className="text-sm text-gray-500">{t("components.post_to_selected_channels")}</p>
              </div>
            </button>
            <button className="flex items-center p-4 border rounded-lg hover:bg-gray-50 transition-colors">
            ...
            <button className="flex items-center p-4 border rounded-lg hover:bg-gray-50 transition-colors">
              ...
              <div className="text-left">
                <p className="font-medium">{t("components.invite_members")}</p>
                <p className="text-sm text-gray-500">{t("components.add_users_to_teams")}</p>
              </div>
            </button>
            <button className="flex items-center p-4 border rounded-lg hover:bg-gray-50 transition-colors">
              <Bell className="w-5 h-5 text-orange-600 mr-3" />
              <div className="text-left">
                <p className="font-medium">{t("components.configure_alerts")}</p>
                <p className="text-sm text-gray-500">{t("components.set_up_notification_rules")}</p>
              </div>
            </button>
          </div>
        </div>
