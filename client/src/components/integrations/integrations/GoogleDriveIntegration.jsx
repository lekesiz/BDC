...
const GoogleDriveIntegration = ({ integration, onBack }) => {const { t } = useTranslation();
  ...
  <>
        ...
        <div className="p-6">
          <div className="flex items-center justify-between mb-4">
            <div className="flex items-center">
              ...
              <div>
                <h3 className="text-lg font-semibold">{t("components.storage_usage")}</h3>
                <p className="text-sm text-gray-500">{t("components.google_drive_storage")}</p>
              </div>
            </div>
            <Button variant="secondary" size="sm">
              <RefreshCw className="w-4 h-4 mr-2" />{t("components.sync_now")}
        ...
        <div className="p-6">
          <div className="flex items-center justify-between mb-4">
            ...
            <Button variant="primary" size="sm">
              <FolderPlus className="w-4 h-4 mr-2" />{t("components.create_folder")}
          ...
          <div key={folder.id} className="flex items-center justify-between p-3 border rounded-lg hover:bg-gray-50">
                <div className="flex items-center">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-500">
                      {folder.files}{t("components.files_")}{folder.size}{t("components._modified")}{folder.lastModified}
                    </p>
                  </div>
                </div>
              ...
              <Badge variant="secondary">
                      <Share2 className="w-3 h-3 mr-1" />{t("components.shared")}

              </Badge>
              }
                  <Button variant="ghost" size="sm">{t("components.open")}
      ...
      <Card>
        <div className="p-6">
          <h3 className="text-lg font-semibold mb-4">{t("components.sync_configuration")}</h3>
          <div className="space-y-4">
            <div className="flex items-center justify-between">
              <div>
                <p className="font-medium">{t("components.automatic_sync")}</p>
                <p className="text-sm text-gray-500">{t("components.keep_files_synchronized_automatically")}</p>
              </div>
            ...
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-2">{t("components.file_types_to_sync")}
            ...
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-2">{t("components.maximum_file_size_mb")}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <button className="flex items-center p-4 border rounded-lg hover:bg-gray-50 transition-colors">
              ...
              <div className="text-left">
                ...
                <p className="text-sm text-gray-500">{t("components.add_files_to_google_drive")}</p>
              </div>
            </button>
            <button className="flex items-center p-4 border rounded-lg hover:bg-gray-50 transition-colors">
              <Download className="w-5 h-5 text-green-600 mr-3" />
              <div className="text-left">
                <p className="font-medium">{t("components.bulk_download")}</p>
                <p className="text-sm text-gray-500">{t("components.download_multiple_files")}</p>
              </div>
            </button>
            <button className="flex items-center p-4 border rounded-lg hover:bg-gray-50 transition-colors">
              <Share2 className="w-5 h-5 text-purple-600 mr-3" />
              <div className="text-left">
                <p className="font-medium">{t("components.share_settings")}</p>
            ...
            <button className="flex items-center p-4 border rounded-lg hover:bg-gray-50 transition-colors">
              ...
              <div className="text-left">
                <p className="font-medium">{t("components.security_scan")}</p>
                <p className="text-sm text-gray-500">{t("components.check_file_security")}</p>
              </div>
            </button>
          </div>
        </div>
      ...
      <Card>
        <div className="p-6">
          <h3 className="text-lg font-semibold mb-4">{t("components.recent_file_activity")}</h3>
          <div className="space-y-3">
            {[
