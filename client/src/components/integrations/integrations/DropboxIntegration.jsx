...
const DropboxIntegration = ({ integration, onBack }) => {const { t } = useTranslation();
  ...
  <>
        ...
        <div className="p-6">
          <div className="flex items-center justify-between mb-4">
            <div className="flex items-center">
              ...
              <div>
                <h3 className="text-lg font-semibold">{t("components.dropbox")}{accountInfo.accountType}</h3>
                <p className="text-sm text-gray-500">{accountInfo.email}</p>
              </div>
            </div>
            <Badge variant="success">{t("components.active")}</Badge>
          </div>
          <div className="space-y-4">
            <div>
              <div className="flex justify-between text-sm mb-2">
                <span className="text-gray-600">{t("components.storage_used")}</span>
                <span className="text-gray-600">
                  {accountInfo.storageUsed}{t("components.gb_")}{accountInfo.storageTotal} GB
                </span>
              </div>
            ...
            <div className="grid grid-cols-3 gap-4">
              <div className="text-center p-3 bg-gray-50 rounded-lg">
                ...
                <p className="text-sm text-gray-600">{t("components.used")}</p>
              </div>
              <div className="text-center p-3 bg-gray-50 rounded-lg">
                <Users className="w-6 h-6 mx-auto mb-2 text-gray-600" />
                <p className="text-2xl font-bold">{accountInfo.teamMembers}</p>
                <p className="text-sm text-gray-600">{t("components.team_members")}</p>
              </div>
              <div className="text-center p-3 bg-gray-50 rounded-lg">
                <FolderSync className="w-6 h-6 mx-auto mb-2 text-gray-600" />
                <p className="text-2xl font-bold">4</p>
                <p className="text-sm text-gray-600">{t("components.synced_folders")}</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <Card>
        <div className="p-6">
          <div className="flex items-center justify-between mb-4">
            <h3 className="text-lg font-semibold">{t("components.synced_folders")}</h3>
            <Button variant="primary" size="sm">
              <FolderSync className="w-4 h-4 mr-2" />{t("components.add_folder")}
                ...
                <div className="flex items-center">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-500">
                      {folder.path} · {folder.files}{t("components.files_")}{folder.size}
                    </p>
                  </div>
                </div>
      ...
      <Card>
        <div className="p-6">
          <h3 className="text-lg font-semibold mb-4">{t("components.backup_configuration")}</h3>
          <div className="space-y-4">
            <div className="flex items-center justify-between">
              <div>
                <p className="font-medium">{t("components.automatic_backup")}</p>
                <p className="text-sm text-gray-500">{t("components.backup_files_automatically")}</p>
              </div>
            ...
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-2">{t("components.backup_frequency")}
            ...
            <div className="flex items-center justify-between">
              <div>
                <p className="font-medium">{t("components.version_control")}</p>
                <p className="text-sm text-gray-500">{t("components.keep_file_version_history")}</p>
              </div>
              <label className="relative inline-flex items-center cursor-pointer">
                <input
                type="checkbox"
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-sm text-gray-500">{t("components.compress_files_before_backup")}</p>
              </div>
              <label className="relative inline-flex items-center cursor-pointer">
                <input
                type="checkbox"
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <button className="flex items-center p-4 border rounded-lg hover:bg-gray-50 transition-colors">
              ...
              <div className="text-left">
                <p className="font-medium">{t("components.upload_files")}</p>
                <p className="text-sm text-gray-500">{t("components.add_files_to_dropbox")}</p>
              </div>
            </button>
            <button className="flex items-center p-4 border rounded-lg hover:bg-gray-50 transition-colors">
              <Link2 className="w-5 h-5 text-purple-600 mr-3" />
              <div className="text-left">
                <p className="font-medium">{t("components.create_share_link")}</p>
                <p className="text-sm text-gray-500">{t("components.share_files_with_link")}</p>
              </div>
            </button>
            <button className="flex items-center p-4 border rounded-lg hover:bg-gray-50 transition-colors">
              <History className="w-5 h-5 text-green-600 mr-3" />
              <div className="text-left">
                <p className="font-medium">{t("components.version_history")}</p>
                <p className="text-sm text-gray-500">{t("components.view_file_versions")}</p>
              </div>
            </button>
            <button className="flex items-center p-4 border rounded-lg hover:bg-gray-50 transition-colors">
              <Shield className="w-5 h-5 text-orange-600 mr-3" />
              <div className="text-left">
                <p className="font-medium">{t("components.security_settings")}</p>
                <p className="text-sm text-gray-500">{t("components.manage_permissions")}</p>
              </div>
            </button>
          </div>
        </div>
      ...
      <Card>
        <div className="p-6">
          <h3 className="text-lg font-semibold mb-4">{t("components.recent_activity")}</h3>
          <div className="space-y-3">
            {[
