    ...
    return (
      <Card className="overflow-hidden h-full">
        <div className="p-6 flex justify-between items-center border-b">
          <h2 className="text-lg font-medium">Skills Development</h2>
        </div>
    ...
    <Card className="overflow-hidden h-full">
      ...
      <div className="p-6 space-y-5">
        ...
        {recentlyImproved.length > 0 && (
          <div>
            <h3 className="text-sm font-medium text-gray-500 mb-3">Recent Improvements</h3>
                ...
                <div key={item.id} className="bg-gray-50 rounded-lg p-3">
                  ...
                  <div className="flex items-center">
                    ...
                    <div className="ml-2 flex space-x-2 text-xs">
                      <span className="text-gray-500">Level {item.previousLevel} → {item.currentLevel}</span>
                    </div>
                  </div>
                </div>
              ))}
