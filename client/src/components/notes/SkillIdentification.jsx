      ...
      <div className="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-lg shadow-md p-6">
        ...
        <div className="space-y-4">
          {insights.strengths && insights.strengths.length > 0 && (
            <div>
              <h4 className="font-medium text-gray-700 mb-2">Strong Skills</h4>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                {insights.careerPaths.map((path, index) => (
                  <div key={index} className="bg-white rounded-lg p-3">
                    ...
                    <p className="text-sm text-gray-600">{path.match}% skill match</p>
                    <div className="mt-2">
    ...
    <div className="space-y-6">
      ...
      <AnimatePresence mode="wait">
        ...
        {viewMode === 'timeline' && (
          ...
          >
            <div className="bg-white rounded-lg shadow-md p-6">
              <h3 className="text-lg font-semibold text-gray-900 mb-4">Skill Development Timeline</h3>
              <div className="h-96">
                <Line
            ...
            {skillData.milestones && skillData.milestones.length > 0 && (
              <div className="bg-white rounded-lg shadow-md p-6">
                <h3 className="text-lg font-semibold text-gray-900 mb-4">Skill Milestones</h3>
                <div className="space-y-4">
        ...
        {viewMode === 'comparison' && (
          ...
          >
            <div className="bg-white rounded-lg shadow-md p-6">
              <h3 className="text-lg font-semibold text-gray-900 mb-4">Top Skills Comparison</h3>
              <div className="h-96">
          ...
          >
            ...
            >
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                <div>
                  ...
                  <div className="space-y-3">
                    ...
                    <div>
                      <p className="text-sm text-gray-500">Last Demonstrated</p>
              ...
              {selectedSkill.history && selectedSkill.history.length > 0 && (
                <div className="mt-6">
                  <h3 className="font-semibold text-gray-700 mb-3">Skill History</h3>
                  <div className="space-y-2">
