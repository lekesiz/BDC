...
const ThemeExtraction = ({ noteId, noteContent }) => {const { t } = useTranslation();
    ...
    onClick={() => setSelectedTheme(theme)}>
      ...
      <div className="flex justify-between items-start mb-3">
        ...
        <div className="flex items-center bg-blue-100 rounded-full px-3 py-1">
          <span className="text-sm font-medium text-blue-800">{t("components.level")}{theme.prominence}</span>
        </div>
      </div>
      {theme.explanation &&
  ...
  const SkillBadge = ({ skill, category }) => {const { t } = useTranslation();
  ...
  const SentimentIndicator = ({ sentiment }) => {const { t } = useTranslation();
      ...
      <div className="flex items-center space-x-4">
        ...
        <div className="flex-1">
          <div className="flex justify-between text-xs text-gray-600 mb-1">
            <span>{t("components.compound_score")}</span>
  ...
  <div className="bg-white rounded-lg shadow-md p-6">
      ...
      <div>
            <h4 className="text-sm font-medium text-gray-700 mb-2">{t("components.main_topics")}</h4>
      ...
      <div>
            <h4 className="text-sm font-medium text-gray-700 mb-2">{t("components.key_insights")}</h4>
            <ul className="list-disc list-inside space-y-1">
      ...
      <div>
            <h4 className="text-sm font-medium text-gray-700 mb-2">{t("components.comprehension_assessment")}</h4>
            <p className="text-sm text-gray-600">{insights.comprehension_assessment}</p>
          </div>
      }
        {insights.next_steps && insights.next_steps.length > 0 &&
      <div>
            <h4 className="text-sm font-medium text-gray-700 mb-2">{t("components.recommended_next_steps")}</h4>
    ...
    return (
      <div className="flex items-center justify-center h-96">
        <div className="text-center">
          ...
          <p className="text-gray-600">{t("components.analyzing_note_content")}</p>
        </div>
      </div>);
  ...
  if (!analysis) {
    return (
      <div className="text-center py-8">
        <p className="text-gray-500">{t("components.no_analysis_available")}</p>
      </div>);
  ...
  return (
    <div className="space-y-6">
      ...
      <AnimatePresence mode="wait">
        ...
        <motion.div
          ...
          className="space-y-6">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              <div className="bg-white rounded-lg shadow-md p-6">
                <h3 className="text-lg font-semibold text-gray-900 mb-4">{t("components.theme_distribution")}</h3>
                <div className="h-80">
                  <Doughnut
              ...
              {/* Theme Cards */}
              <div className="space-y-4">
                <h3 className="text-lg font-semibold text-gray-900">{t("components.identified_themes")}</h3>
        ...
        <motion.div
          ...
          className="space-y-6">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              <div className="bg-white rounded-lg shadow-md p-6">
                <h3 className="text-lg font-semibold text-gray-900 mb-4">{t("components.concept_analysis")}</h3>
                <div className="h-80">
                  <Radar
              ...
              {/* Word Cloud */}
              <div className="bg-white rounded-lg shadow-md p-6">
                <h3 className="text-lg font-semibold text-gray-900 mb-4">{t("components.key_terms")}</h3>
                <div className="h-80">
                  <WordCloud
            ...
            {/* Concept Cards */}
            <div>
              <h3 className="text-lg font-semibold text-gray-900 mb-4">{t("components.identified_concepts")}</h3>
        ...
        <motion.div
          ...
          className="space-y-6">
            ...
            {/* Skills Chart */}
            <div className="bg-white rounded-lg shadow-md p-6">
              <h3 className="text-lg font-semibold text-gray-900 mb-4">{t("components.skills_distribution")}</h3>
              <div className="h-80">
                <Bar
                data={getSkillsChart()}
                options={{
        ...
        <motion.div
          ...
          className="space-y-6">
            ...
            {/* Overall Sentiment */}
            <div className="bg-white rounded-lg shadow-md p-6">
              <h3 className="text-lg font-semibold text-gray-900 mb-4">{t("components.overall_sentiment")}</h3>
              <SentimentIndicator sentiment={analysis.sentiment} />
            </div>
            {/* Sentence-level Analysis */}
            {analysis.sentiment.sentence_analysis &&
          <div className="bg-white rounded-lg shadow-md p-6">
                <h3 className="text-lg font-semibold text-gray-900 mb-4">{t("components.sentence_analysis")}</h3>
          ...
          <div className="bg-white rounded-lg shadow-md p-6">
                <h3 className="text-lg font-semibold text-gray-900 mb-4">{t("components.emotion_words")}</h3>
        ...
        <motion.div
          ...
          className="space-y-6">
            ...
            <div className="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-lg shadow-md p-6">
              <h3 className="text-lg font-semibold text-gray-900 mb-3">{t("components.oneline_summary")}</h3>
            ...
            {/* Abstractive Summary */}
            <div className="bg-white rounded-lg shadow-md p-6">
              <h3 className="text-lg font-semibold text-gray-900 mb-3">{t("components.executive_summary")}</h3>
          ...
          <div className="bg-white rounded-lg shadow-md p-6">
                <h3 className="text-lg font-semibold text-gray-900 mb-4">{t("components.key_points")}</h3>
            ...
            {/* Extractive Summary */}
            <div className="bg-white rounded-lg shadow-md p-6">
              <h3 className="text-lg font-semibold text-gray-900 mb-3">{t("components.extract_summary")}</h3>
              <p className="text-gray-700 leading-relaxed">
      ...
      <div className="bg-white rounded-lg shadow-md p-6">
          <h3 className="text-lg font-semibold text-gray-900 mb-4">{t("components.note_quality_score")}</h3>
          <div className="flex items-center justify-between">
            <div className="flex-1">
              <div className="flex justify-between text-sm text-gray-600 mb-2">
                <span>{t("components.overall_quality")}</span>
        ...
        <div className="mt-6 grid grid-cols-2 md:grid-cols-4 gap-4 text-sm">
              <div>
                <p className="text-gray-500">{t("components.words")}</p>
                <p className="font-semibold">{analysis.text_statistics.word_count}</p>
              </div>
              <div>
                <p className="text-gray-500">{t("components.sentences")}</p>
                <p className="font-semibold">{analysis.text_statistics.sentence_count}</p>
              </div>
              <div>
                <p className="text-gray-500">{t("components.readability")}</p>
                <p className="font-semibold">
                  {analysis.text_statistics.readability_score?.toFixed(1) || 'N/A'}
                </p>
              </div>
              <div>
                <p className="text-gray-500">{t("components.grade_level")}</p>
                <p className="font-semibold">
      ...
      <AnimatePresence>
        ...
        <motion.div
          ...
          onClick={() => setSelectedTheme(null)}>
            ...
            <div className="mb-4">
                  <h3 className="font-semibold text-gray-700 mb-2">{t("components.explanation")}</h3>
            ...
            <div className="mb-4">
              ...
              <div className="flex items-center justify-between mt-6">
                <div className="flex items-center">
                  <span className="text-sm text-gray-500 mr-2">{t("components.prominence")}</span>
                  <div className="flex">
                    {[1, 2, 3, 4, 5].map((level) =>
                  <svg
                    key={level}
                ...
                <button
                onClick={() => setSelectedTheme(null)}
                className="px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700">{t("components.close")}
