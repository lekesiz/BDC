...
const NotificationPreferencesPageV2 = () => {
    ...
    <div className="min-h-screen bg-gray-50 p-6">
      <div className="max-w-4xl mx-auto">
        <div className="mb-6">
          ...
          <h1 className="text-2xl font-bold mb-2">Bildirim Tercihleri</h1>
          <p className="text-gray-600">Bildirimlerin nasıl ve ne zaman alacağınızı yapılandırın</p>
        </div>

        {/* Master Channel Switches */}
        <div className="bg-white rounded-lg shadow-md p-6 mb-6">
          <h3 className="text-lg font-semibold mb-4">Bildirim Kanalları</h3>
        ...
        <div className="bg-white rounded-lg shadow-md p-6 mb-6">
          <h3 className="text-lg font-semibold mb-4">Kategori Bazlı Tercihler</h3>
        ...
        {/* Timing Preferences */}
        <div className="bg-white rounded-lg shadow-md p-6 mb-6">
          <h3 className="text-lg font-semibold mb-4">Bildirim Zamanlaması</h3>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              <p className="font-medium mb-3">Bildirim Sıklığı</p>
            ...
            <div>
              <p className="font-medium mb-3">Sessiz Saatler</p>
        ...
        {/* Digest Settings */}
        <div className="bg-white rounded-lg shadow-md p-6 mb-6">
          <h3 className="text-lg font-semibold mb-4">Özet Bildirimleri</h3>
          <label className="flex items-center mb-4">
            <input
              ...
              className="mr-2"
            />
            <span>Özet bildirimleri al</span>
          </label>
          ...
          {preferences.digest.enabled && (
            <div className="space-y-4">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  <label className="block text-sm font-medium mb-2">Özet Zamanı</label>
                  <input
                    type="time"
                ...
                <div>
                  <label className="block text-sm font-medium mb-2">Özet Sıklığı</label>
                  <select
              ...
              <div>
                <label className="block text-sm font-medium mb-2">Özete Dahil Edilecek Kategoriler</label>
        ...
        {/* Frequency Limits */}
        <div className="bg-white rounded-lg shadow-md p-6 mb-6">
          <h3 className="text-lg font-semibold mb-4">Frekans Limitleri</h3>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div>
              <label className="block text-sm font-medium mb-2">
                Günlük E-posta Limiti
              </label>
              <input
                type="number"
        ...
        <div className="mt-6 bg-blue-50 border border-blue-200 rounded-lg p-4">
          <div className="flex items-start">
            ...
            <div>
              <p className="font-medium text-blue-900">Bildirim İpuçları</p>
              <ul className="text-sm text-blue-800 mt-2 space-y-1">
                <li>• Önemli bildirimleri kaçırmamak için en az bir kanal aktif bırakın</li>
                <li>• Sessiz saatler, acil bildirimler için geçerli olmayabilir</li>
                <li>• SMS bildirimleri ek ücrete tabi olabilir</li>
