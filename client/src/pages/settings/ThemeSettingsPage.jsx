        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6">
          ...
          <div className="space-y-4">
            <div className="p-4 bg-gray-50 dark:bg-gray-700 rounded">
              <h4 className="text-lg font-medium mb-2 text-gray-900 dark:text-white">Örnek Başlık</h4>
              <p className="text-gray-600 dark:text-gray-300">
                Bu bir örnek metindir. Seçtiğiniz tema ve ayarların görünümünü buradan kontrol edebilirsiniz.
              </p>
              <div className="mt-4 space-x-2">
                <button className="px-4 py-2 bg-blue-500 text-white rounded hover:bg-blue-600">
                  Birincil Buton
                </button>
                <button className="px-4 py-2 border border-gray-300 dark:border-gray-600 text-gray-700 dark:text-gray-300 rounded hover:bg-gray-50 dark:hover:bg-gray-700">
                  İkincil Buton
                </button>
              </div>
            </div>
