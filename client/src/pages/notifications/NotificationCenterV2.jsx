...
const NotificationCenterV2 = () => {const { t } = useTranslation();
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <div className="max-w-6xl mx-auto p-6">
        {/* Header */}
        <div className="mb-6">
          <h1 className="text-2xl font-bold mb-2">{t("pages.bildirim_merkezi")}</h1>
          <p className="text-gray-600">{t("pages.tm_bildirimlerinizi_tek_bir_yerden_ynetin")}</p>
        </div>
        {/* Stats */}
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
          <div className="bg-white rounded-lg shadow-md p-4">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm text-gray-600">{t("pages.toplam")}</p>
          ...
          <div className="bg-white rounded-lg shadow-md p-4">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm text-gray-600">{t("pages.bu_hafta")}</p>
        ...
        <div className="flex flex-col lg:flex-row gap-6">
          ...
          <div className="lg:w-64">
            ...
            <div className="bg-white rounded-lg shadow-md p-4 mb-4">
              <h3 className="font-semibold mb-3">{t("pages.kategoriler")}</h3>
            ...
            <div className="bg-white rounded-lg shadow-md p-4">
              <h3 className="font-semibold mb-3 flex items-center">
                <FaFilter className="mr-2" />{t("pages.filtreler")}

              </h3>
              <div className="mb-4">
                <label className="block text-sm font-medium mb-2">{t("pages.okunma_durumu")}</label>
                <select
                  value={readFilter}
              ...
              <div>
                <label className="block text-sm font-medium mb-2">{t("components.zaman_aral")}</label>
                <select
                  value={timeFilter}
                  ...
                  <option value="week">{t("pages.bu_hafta")}</option>
                  <option value="month">{t("pages.bu_ay")}</option>
                </select>
              </div>
            </div>
          </div>
          ...
          <div className="flex-1">
                ...
                <div className="flex items-center space-x-4">
                  ...
                  <>
                      ...
                      className="text-blue-500 hover:text-blue-600 text-sm">
                        ...
                        <FaCheck className="inline mr-1" />{t("pages.okundu_iaretle")}
                      ...
                      className="text-red-500 hover:text-red-600 text-sm">
                        ...
                        <FaTrash className="inline mr-1" />{t("components.sil")}
            ...
            <div className="bg-white rounded-lg shadow-md p-8 text-center">
                ...
                <p className="text-gray-600">{t("pages.bildirim_bulunamad")}</p>
              </div> :
      ...
      <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-lg max-w-md w-full">
            <div className="flex justify-between items-center p-6 border-b">
              <h3 className="text-lg font-semibold">{t("pages.bildirim_tercihleri")}</h3>
              <button
            ...
            <div className="p-6">
              ...
              <div className="mt-6 space-y-4">
                <div>
                  <label className="block text-sm font-medium mb-2">{t("pages.bildirim_skl")}</label>
                  <select className="w-full px-3 py-2 border rounded">
                    <option value="realtime">{t("pages.gerek_zamanl")}</option>
                    <option value="hourly">{t("pages.saatlik_zet")}</option>
                    <option value="daily">{t("pages.gnlk_zet")}</option>
                    <option value="weekly">{t("pages.haftalk_zet")}</option>
                  </select>
                </div>
                <div>
                  <label className="block text-sm font-medium mb-2">{t("pages.sessiz_saatler")}</label>
              ...
              <div className="flex justify-end space-x-2 mt-6">
                ...
                className="bg-blue-500 text-white px-4 py-2 rounded hover:bg-blue-600">{t("pages.kaydet")}
