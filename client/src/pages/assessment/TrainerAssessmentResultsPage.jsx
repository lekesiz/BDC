 ...
 */
const TrainerAssessmentResultsPage = () => {
  const { id } = useParams();
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          <div className="flex items-center">
            ...
            <div>
              ...
              <p className="text-xs text-gray-500">
                {Math.round((assessment.submissions.completed / assessment.submissions.total) * 100)}% completion rate
              </p>
            </div>
          </div>
          <div className="flex items-center">
            ...
            <Card className="p-6">
                  ...
                  {analytics.score_distribution.map((range) => (
                    <div key={range.range}>
                      <div className="flex justify-between mb-2">
                        ...
                        <span className="text-sm text-gray-500">
                          {range.count} students ({Math.round((range.count / assessment.submissions.completed) * 100)}%)
                        </span>
                      </div>
                      <Progress 
              ...
              {assessment.submissions.averageScore !== null && (
                <div className="mt-8 p-4 bg-purple-50 rounded-lg text-center">
                  <h4 className="text-sm font-medium text-gray-700 mb-1">Average Score</h4>
        ...
        <Tabs.TabContent value="submissions">
          ...
          <div className="flex flex-col md:flex-row gap-4 items-center mb-6">
            ...
            >
              ...
              <Select.Content>
                <Select.Item value="all">All Scores</Select.Item>
                ...
                <Select.Item value="below-60">Below 60%</Select.Item>
              </Select.Content>
            </Select>
          </div>
          {/* Submissions Table */}
              ...
              <Table>
                ...
                <Table.Body>
                  {filteredSubmissions.length > 0 ? (
                    ...
                    <Table.Row>
                      <Table.Cell colSpan={6} className="text-center py-6 text-gray-500">
                  ...
                  <Table>
                    <Table.Header>
                      <Table.Row>
                        ...
                        <Table.Head>Correct Rate</Table.Head>
                  ...
                  {analytics.common_mistakes.map((mistake) => (
                    <div key={mistake.question_id} className="p-4 bg-gray-50 rounded-lg">
                      <div className="flex justify-between items-start mb-2">
                        <div>
                          <p className="font-medium">Question ID: {mistake.question_id}</p>
                          <p className="text-sm text-gray-600">{mistake.description}</p>
                        </div>
                        <Badge className="bg-red-100 text-red-800">{mistake.frequency}% of students</Badge>
                      </div>
                    </div>
                  ))}
                </div>
            ...
            <Card className="p-6">
              ...
              <div className="mt-6">
                ...
                {!analytics?.time_ranges ? (
                  <div className="text-center py-6 text-gray-500">
                    Time distribution data not available
                  </div>
                ) : (
