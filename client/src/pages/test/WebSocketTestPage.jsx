...
const WebSocketTestPage = () => {const { t } = useTranslation();
    ...
    <div className="max-w-4xl mx-auto p-6">
      ...
      <div className="grid gap-6 md:grid-cols-2">
        ...
        <div className="bg-white rounded-lg shadow p-4">
          <h2 className="text-xl font-semibold mb-4">{t("components.send_message")}</h2>
          <div className="space-y-3">
            ...
            <button
              onClick={sendMessage}
              disabled={!connected}
              className="w-full bg-blue-500 text-white px-4 py-2 rounded hover:bg-blue-600 disabled:bg-gray-400">{t("components.send_message")}
      ...
      {/* Messages */}
      <div className="mt-6 bg-white rounded-lg shadow p-4">
        <h2 className="text-xl font-semibold mb-4">{t("components.messages")}</h2>
