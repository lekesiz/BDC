...
const NotificationTestPage = () => {const { t } = useTranslation();
  ...
  return (
    <div className="max-w-4xl mx-auto p-6">
      ...
      <div className="bg-white rounded-lg shadow p-6">
        <h2 className="text-xl font-semibold mb-4">{t("mobile.send_test_notification")}</h2>
        <div className="space-y-4">
          <div>
            <label className="block text-sm font-medium mb-1">{t("components.title")}</label>
            <input
              type="text"
              name="title"
          ...
          <div>
            <label className="block text-sm font-medium mb-1">{t("components.message")}</label>
            <textarea
              name="message"
          ...
          <div>
            <label className="block text-sm font-medium mb-1">{t("components.type")}</label>
            <select
              name="type"
              ...
              <option value="info">{t("components.info")}</option>
              <option value="success">{t("components.success")}</option>
              <option value="warning">{t("components.warning")}</option>
              <option value="error">{t("components.error")}</option>
            </select>
          </div>
          <div>
      ...
      <div className="mt-6 bg-white rounded-lg shadow p-6">
        <h2 className="text-xl font-semibold mb-4">{t("components.instructions")}</h2>
