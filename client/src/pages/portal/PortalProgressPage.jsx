...
const PortalProgressPage = () => {const { t } = useTranslation();
    ...
    return (
      <div className="container mx-auto py-6">
        <div className="text-center">
          <h2 className="text-xl font-semibold">{t("pages.no_progress_data_available")}</h2>
          <p className="text-gray-600 mt-2">{t("pages.your_progress_information_will_appear_here_once_yo")}</p>
        </div>
      </div>);
  ...
  return (
    <div className="container mx-auto py-6">
      {/* Page header */}
      <div className="mb-8">
        <h1 className="text-2xl font-bold mb-2">{t("components.my_program_progress")}</h1>
        <p className="text-gray-600">{t("pages.track_your_learning_journey_and_progress_in_the")}
          {progressData?.program?.name || 'your'} program
        </p>
      </div>
      {/* Overview metrics */}
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
        ...
        <Card className="p-6">
          <div className="flex items-center mb-4">
            ...
            <div>
              <h3 className="text-sm font-medium text-gray-500">{t("components.overall_progress")}</h3>
          ...
          <div className="flex justify-between text-sm text-gray-500">
            ...
            <span>{t("pages.expected_end")}{formatDate(progressData.program.expectedEndDate)}</span>
          </div>
        </Card>
        {/* Modules */}
        <Card className="p-6">
          <div className="flex items-center mb-4">
            ...
            <div>
              <h3 className="text-sm font-medium text-gray-500">{t("pages.modules")}</h3>
          ...
          <div className="flex justify-between mb-2">
            <span className="text-sm text-gray-500">{t("components.completed")}</span>
          ...
          <div className="flex justify-between text-sm">
            <div className="flex items-center">
              ...
              <span className="text-gray-500">{t("pages.completed_")}{progressData.moduleStats.completed})</span>
            </div>
            <div className="flex items-center">
              <div className="w-3 h-3 rounded-full bg-blue-500 mr-1"></div>
              <span className="text-gray-500">{t("pages.in_progress_")}{progressData.moduleStats.inProgress})</span>
            </div>
            <div className="flex items-center">
              <div className="w-3 h-3 rounded-full bg-gray-300 mr-1"></div>
              <span className="text-gray-500">{t("pages.not_started_")}{progressData.moduleStats.notStarted})</span>
            </div>
          </div>
        </Card>
        ...
        <Card className="p-6">
          <div className="flex items-center mb-4">
            ...
            <div>
              <h3 className="text-sm font-medium text-gray-500">{t("pages.time_remaining")}</h3>
              <p className="text-2xl font-bold">{daysRemaining} days</p>
            </div>
          </div>
          <div className="space-y-2 mb-3">
            <div className="flex justify-between text-sm">
              <span className="text-gray-500">{t("components.time_spent")}</span>
              <span className="font-medium">{formatDuration(progressData.timeStats.spent)}</span>
            </div>
            <div className="flex justify-between text-sm">
              <span className="text-gray-500">{t("pages.estimated_total")}</span>
          ...
          <div className="flex items-center text-sm text-green-600 bg-green-50 p-2 rounded">
              ...
              <span>{t("pages.youre_on_track_to_complete_on_time")}</span>
            </div> :
      ...
      <div className="mb-8">
          <div className="flex justify-between items-center mb-4">
            <h2 className="text-xl font-semibold">{t("pages.recent_achievements")}</h2>
            <Button
            variant="link"
            onClick={() => navigate('/portal/achievements')}
            className="text-sm flex items-center">{t("archive-components.view_all")}
      ...
      <div className="mb-8">
        <h2 className="text-xl font-semibold mb-4">{t("pages.module_progress")}</h2>
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
          {/* Module list */}
          <div className="lg:col-span-1">
            <Card className="overflow-hidden">
              <div className="p-4 border-b bg-gray-50">
                <h3 className="font-medium">{t("pages.modules")}</h3>
              </div>
          ...
          <div className="lg:col-span-3">
            ...
            <Card className="overflow-hidden">
                ...
                <div className="p-6">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
                    <div className="bg-gray-50 rounded-lg p-4">
                      <h4 className="text-sm text-gray-500 mb-1">{t("archive-components.progress")}</h4>
                      <div className="flex items-center">
                    ...
                    <div className="bg-gray-50 rounded-lg p-4">
                      <h4 className="text-sm text-gray-500 mb-1">{t("pages.lessons_completed")}</h4>
                      <div className="text-2xl font-bold">
                        {selectedModuleDetails.lessonsCompleted}/{selectedModuleDetails.totalLessons}
                      </div>
                    </div>
                    <div className="bg-gray-50 rounded-lg p-4">
                      <h4 className="text-sm text-gray-500 mb-1">{t("pages.time_spent")}</h4>
                      <div className="text-2xl font-bold">
                  ...
                  {/* Lesson progress */}
                  <h4 className="font-medium mb-3">{t("pages.lesson_progress")}</h4>
                          ...
                          <Clock className="h-5 w-5 text-gray-400" />
                            ...
                            <div>
                              ...
                              <div className="flex items-center mt-2 space-x-4 text-xs">
                                ...
                                {lesson.lastAccessed &&
                            <span className="text-gray-500">{t("pages.last_accessed")}
                ...
                <div>
                      <h4 className="font-medium mb-3">{t("pages.module_resources")}</h4>
            ...
            <Card className="p-8 text-center">
                ...
                <h3 className="text-lg font-medium text-gray-900 mb-1">{t("pages.no_module_selected")}</h3>
                <p className="text-gray-500">{t("pages.please_select_a_module_from_the_list_to_view_detai")}
      ...
      <div className="mb-8">
          <h2 className="text-xl font-semibold mb-4">{t("pages.program_certificate")}</h2>
          <Card className="p-6">
            <div className="md:flex items-center justify-between">
              <div className="mb-4 md:mb-0">
                <div className="flex items-center mb-2">
                  <Award className="h-6 w-6 text-yellow-500 mr-2" />
                  <h3 className="text-lg font-medium">{progressData.program.name}{t("components.certificate")}</h3>
                </div>
                ...
                <div className="flex items-center">
                  ...
                  <div>
                    <div className="text-sm font-medium">{t("pages.certificate_progress")}</div>
                    <div className="text-xs text-gray-500">
                      {progressData.programCertificate.currentCompletion} of {progressData.programCertificate.requiredCompletion}{t("pages.required_modules")}
                  </div>
                  </div>
                </div>
              </div>
      ...
      <div>
          <h2 className="text-xl font-semibold mb-4">{t("pages.learning_recommendations")}</h2>
