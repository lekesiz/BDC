...
const PortalCalendarPage = () => {const { t } = useTranslation();
  ...
  return (
    <div className="container mx-auto py-6">
      <div className="flex justify-between items-center mb-6">
        <h1 className="text-2xl font-bold">{t("components.calendar")}</h1>
      ...
      <div className="space-y-6">
          ...
          <Card className="overflow-hidden">
            <div className="p-6 border-b">
              <h2 className="text-lg font-medium">{t("pages.sessions_for")}
                ...
                'bg-gray-50'}`
                  ...
                  <p className="mt-2 text-sm text-gray-600">{session.description}</p>
                        ...
                        <div className="mt-3">
                          <Button
                      variant="link"
                      className="text-primary p-0 h-auto flex items-center">{t("pages.view_session_details")}
          ...
          <div className="p-8 text-center">
                ...
                <p className="text-gray-500">{t("pages.no_sessions_scheduled_for_this_day")}</p>
              </div>
          }
          </Card>
        </div> :
      ...
      <div className="space-y-6">
                ...
                'bg-gray-50'}`
                      ...
                      <div className="flex-1">
                        <div className="flex justify-between items-start">
                          ...
                          <span className="px-2 py-1 text-xs font-medium rounded-full bg-blue-100 text-blue-800">{t("components.upcoming")}
          ...
          <div className="p-8 text-center">
                <CalendarIcon className="h-12 w-12 text-gray-300 mx-auto mb-3" />
                <p className="text-gray-500">{t("pages.no_upcoming_sessions_scheduled")}</p>
              </div>
          }
          </Card>
        </div>
