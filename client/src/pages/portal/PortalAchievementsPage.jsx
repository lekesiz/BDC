              ...
              <div className="p-6">
                ...
                {achievement.type === 'certificate' && (
                  <Button 
                    ...
                    variant="outline" 
                    className="w-full"
                    onClick={() => window.open(`/api/portal/certificates/${achievement.id}/download`, '_blank')}
                  >
                    View Certificate
                  </Button>
                )}
                      ...
                      <div>
                        ...
                        {certificate.isEarned ? (
                          <div className="flex items-center text-sm text-green-600">
                            ...
                            <span>Earned on {formatDate(certificate.dateEarned)}</span>
                          </div>
                        ) : (
