    ...
    <div className="space-y-6">
        ...
        <Card>
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-xs text-gray-500">
                vs {cacheStats.avgResponseTime * 3}ms uncached
              </p>
            </div>
            ...
            {cache.memory && (
              <div className="space-y-2">
                <div className="flex justify-between text-sm">
                  ...
                  <span>{cache.memory.used}MB / {cache.memory.total}MB</span>
                </div>
      ...
      <Card>
        ...
        <div className="h-64 flex items-center justify-center bg-gray-50 rounded">
          <p className="text-gray-600">Cache performance chart would go here</p>
        </div>
      </Card>
    </div>
  );
    ...
    <div className="space-y-6">
      ...
      <Card>
        <div className="flex justify-between items-center mb-4">
          <h3 className="font-semibold text-lg">Cache Keys</h3>
            ...
            <table className="min-w-full divide-y divide-gray-200">
              <thead>
                <tr>
                  ...
                  <th className="px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase">Value Size</th>
    ...
    <div className="space-y-6">
      <Card>
        ...
        <div className="space-y-4">
          {/* TTL Setting */}
          <div>
            <label className="block text-sm font-medium mb-1">Default TTL (seconds)</label>
            <input
              type="number"
          ...
          <div className="flex items-center justify-between">
            <div>
              <p className="font-medium">Cache Warmup</p>
              <p className="text-sm text-gray-600">Pre-populate cache on startup</p>
            </div>
            <label className="relative inline-flex items-center cursor-pointer">
              <input
                type="checkbox"
          ...
          <div className="flex items-center justify-between">
            <div>
              <p className="font-medium">Preload Critical Data</p>
              <p className="text-sm text-gray-600">Load frequently accessed data on demand</p>
            </div>
            <label className="relative inline-flex items-center cursor-pointer">
              <input
                type="checkbox"
            ...
            <div key={index} className="border rounded-lg p-4">
              <div className="flex items-start space-x-3">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-sm text-gray-500">Suggested action: {suggestion.action}</p>
                </div>
                <Button size="sm">
                  Implement
                </Button>
  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <h1 className="text-2xl font-bold">Caching System</h1>
        <Button
