...
const ImageOptimizationPage = () => {const { t } = useTranslation();
  ...
  <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        <Card>
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm text-gray-600">{t("pages.total_images")}</p>
        ...
        <Card>
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm text-gray-600">{t("pages.total_size")}</p>
        ...
        <Card>
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm text-gray-600">{t("pages.space_saved")}</p>
        ...
        <Card>
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm text-gray-600">{t("pages.formats")}</p>
      ...
      {/* Quick Actions */}
      <Card>
        <h3 className="font-semibold text-lg mb-4">{t("archive-components.quick_actions")}</h3>
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          ...
          disabled={stats.unoptimizedCount === 0}>
            ...
            <Zap className="w-4 h-4 mr-2" />{t("pages.optimize_all")}
          ...
          onClick={() => setActiveTab('batch')}>
            ...
            <FolderOpen className="w-4 h-4 mr-2" />{t("pages.batch_process")}
      ...
      <Card>
        <h3 className="font-semibold text-lg mb-4">{t("pages.format_distribution")}</h3>
        <div className="h-64 flex items-center justify-center bg-gray-50 rounded">
          <p className="text-gray-600">{t("pages.format_distribution_chart_would_go_here")}</p>
        </div>
      </Card>
      {/* Recent Images */}
      <Card>
        <h3 className="font-semibold text-lg mb-4">{t("pages.recent_images")}</h3>
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        ...
        <div className="flex items-center justify-between">
          <div className="flex space-x-4">
            <select className="p-2 border rounded-lg">
              <option value="">{t("pages.all_formats")}</option>
              <option value="jpg">JPEG</option>
              <option value="png">PNG</option>
              <option value="webp">{t("pages.webp")}</option>
              <option value="avif">AVIF</option>
            </select>
            <select className="p-2 border rounded-lg">
              <option value="">{t("pages.all_statuses")}</option>
              <option value="optimized">{t("pages.optimized")}</option>
              <option value="unoptimized">{t("pages.unoptimized")}</option>
            </select>
          </div>
          ...
          <>
              ...
              onClick={() => optimizeImages(selectedImages)}>
                  ...
                  <Zap className="w-4 h-4 mr-2" />{t("pages.optimize_selected_")}
              {selectedImages.length})
                </Button>
                <Button
              variant="secondary"
              onClick={() => setSelectedImages([])}>{t("pages.clear_selection")}
  ...
  <div className="space-y-6">
      ...
      {batchProgress !== null &&
    <Card>
          <h3 className="font-semibold text-lg mb-4">{t("pages.optimization_progress")}</h3>
          <div className="space-y-2">
            <div className="flex justify-between text-sm">
              <span>{t("pages.processing_images")}</span>
      ...
      {/* Batch Settings */}
      <Card>
        <h3 className="font-semibold text-lg mb-4">{t("pages.batch_optimization_settings")}</h3>
        <div className="space-y-4">
          ...
          <div>
            ...
            <div className="flex justify-between text-xs text-gray-500 mt-1">
              <span>{t("pages.low_10")}</span>
              <span>{t("pages.medium_50")}</span>
              <span>{t("pages.high_100")}</span>
            </div>
          </div>
          {/* Format Selection */}
          <div>
            <label className="block text-sm font-medium mb-2">{t("pages.output_format")}</label>
          ...
          <div>
            <div className="flex items-center mb-3">
              ...
              <label htmlFor="resize" className="font-medium">{t("pages.resize_images")}</label>
            </div>
          ...
          <div className="grid grid-cols-2 gap-4 ml-6">
                ...
                <div>
                  <label className="block text-sm mb-1">{t("pages.max_height")}</label>
                  <input
                type="number"
                className="w-full p-2 border rounded-lg"
          ...
          {/* Generate Sizes */}
          <div>
            <label className="block text-sm font-medium mb-2">{t("pages.generate_sizes")}</label>
            <div className="grid grid-cols-2 md:grid-cols-5 gap-3">
          ...
          <div className="space-y-3">
            <label className="flex items-center cursor-pointer">
              ...
              <span>{t("pages.strip_metadata_exif_iptc_etc")}</span>
            </label>
            <label className="flex items-center cursor-pointer">
              <input
              type="checkbox"
              ...
              <span>{t("pages.progressive_loading_better_perceived_performance")}</span>
            </label>
            <label className="flex items-center cursor-pointer">
              <input
              type="checkbox"
              ...
              <span>{t("pages.enable_lazy_loading_for_web")}</span>
            </label>
          </div>
          <div className="flex space-x-2 pt-4">
            <Button
            onClick={() => updateConfig(optimizationConfig)}>{t("pages.save_settings")}


          </Button>
            <Button
            variant="secondary"
            onClick={() => optimizeImages(images.map((img) => img.id))}>{t("pages.apply_to_all_images")}
      ...
      {/* Batch Results */}
      <Card>
        <h3 className="font-semibold text-lg mb-4">{t("pages.recent_optimization_results")}</h3>
        <div className="space-y-3">
          {[
        ...
        <div key={index} className="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
              <div>
                ...
                <p className="text-sm text-gray-600">{result.images}{t("pages.images_optimized")}</p>
              </div>
  ...
  <div className="space-y-6">
      <Card>
        <h3 className="font-semibold text-lg mb-4">{t("pages.global_image_settings")}</h3>
        <div className="space-y-4">
          {/* Auto-optimization */}
          <div className="flex items-center justify-between">
            <div>
              <p className="font-medium">{t("pages.autooptimize_on_upload")}</p>
              <p className="text-sm text-gray-600">{t("pages.automatically_optimize_images_when_uploaded")}</p>
            </div>
          ...
          <div className="flex items-center justify-between">
            <div>
              <p className="font-medium">{t("pages.webp_with_fallback")}</p>
              <p className="text-sm text-gray-600">{t("pages.serve_webp_images_with_jpegpng_fallback")}</p>
            </div>
            <label className="relative inline-flex items-center cursor-pointer">
              <input
              type="checkbox"
          ...
          <div className="flex items-center justify-between">
            <div>
              <p className="font-medium">{t("pages.generate_responsive_sizes")}</p>
              <p className="text-sm text-gray-600">{t("pages.create_multiple_sizes_for_responsive_design")}</p>
            </div>
            <label className="relative inline-flex items-center cursor-pointer">
              <input
              type="checkbox"
          ...
          {/* Storage location */}
          <div>
            <label className="block text-sm font-medium mb-2">{t("pages.storage_location")}</label>
            <select className="w-full p-2 border rounded-lg">
              <option value="local">{t("components.local_storage")}</option>
              <option value="s3">{t("pages.amazon_s3")}</option>
              <option value="cloudinary">{t("pages.cloudinary")}</option>
              <option value="custom">{t("pages.custom_cdn")}</option>
            </select>
          </div>
          {/* CDN settings */}
          <div>
            <label className="block text-sm font-medium mb-2">{t("pages.cdn_domain")}</label>
            <input
            type="text"
            className="w-full p-2 border rounded-lg"
              ...
              <div className="flex justify-between items-center">
                <div>
                  ...
                  <p className="text-xs text-gray-500 mt-1">
                    Quality: {preset.quality}{t("pages._format")}{preset.format}
                  </p>
                </div>
                <Button
              size="sm"
      ...
      {/* Image Rules */}
      <Card>
        <h3 className="font-semibold text-lg mb-4">{t("pages.image_processing_rules")}</h3>
        <div className="space-y-3">
          <div className="border rounded-lg p-4">
            <div className="flex items-center justify-between mb-2">
              <h4 className="font-medium">{t("pages.avatar_images")}</h4>
              <label className="relative inline-flex items-center cursor-pointer">
                <input type="checkbox" className="sr-only peer" defaultChecked />
                <div className="w-11 h-6 bg-gray-200 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-primary/10 rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-primary"></div>
              </label>
            </div>
            <p className="text-sm text-gray-600">{t("pages.square_crop_200x200_high_quality")}</p>
          </div>
          <div className="border rounded-lg p-4">
            <div className="flex items-center justify-between mb-2">
              <h4 className="font-medium">{t("pages.document_thumbnails")}</h4>
              <label className="relative inline-flex items-center cursor-pointer">
                <input type="checkbox" className="sr-only peer" defaultChecked />
                <div className="w-11 h-6 bg-gray-200 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-primary/10 rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-primary"></div>
              </label>
            </div>
            <p className="text-sm text-gray-600">{t("pages.169_ratio_320x180_medium_quality")}</p>
          </div>
          <div className="border rounded-lg p-4">
            <div className="flex items-center justify-between mb-2">
              <h4 className="font-medium">{t("pages.content_images")}</h4>
              <label className="relative inline-flex items-center cursor-pointer">
                <input type="checkbox" className="sr-only peer" defaultChecked />
                <div className="w-11 h-6 bg-gray-200 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-primary/10 rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-primary"></div>
              </label>
  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <h1 className="text-2xl font-bold">{t("pages.image_optimization")}</h1>
        <Button
