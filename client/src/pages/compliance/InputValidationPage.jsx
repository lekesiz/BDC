...
const InputValidationPage = () => {const { t } = useTranslation();
  ...
  <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        ...
        <Card>
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm text-gray-600">{t("pages.blocked_attacks")}</p>
        ...
        <Card>
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm text-gray-600">{t("pages.false_positives")}</p>
        ...
        <Card>
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm text-gray-600">{t("pages.performance_impact")}</p>
      ...
      <Card>
        ...
        <div className="space-y-4">
          <div>
            <label className="block text-sm font-medium mb-1">{t("pages.test_input")}</label>
            <textarea
        ...
        <div className="mt-4 space-y-2">
              <h4 className="font-medium">{t("pages.test_results")}</h4>
  ...
  <div className="space-y-6">
      <Card>
        <div className="flex justify-between items-center mb-4">
          ...
          <Button size="sm">
            <Plus className="w-4 h-4 mr-2" />{t("pages.add_custom_rule")}
        ...
        <div key={rule.id} className="border rounded-lg p-4">
              <div className="space-y-4">
                ...
                <div>
                  ...
                  {rule.pattern &&
              <div className="mb-3">
                      <p className="text-xs font-medium text-gray-500 mb-1">{t("pages.patternregex")}</p>
              ...
              <div className="mb-3">
                      <p className="text-xs font-medium text-gray-500 mb-1">{t("pages.allowed_extensions")}</p>
                  ...
                  {rule.allowedTags &&
              <div className="mb-3">
                      <p className="text-xs font-medium text-gray-500 mb-1">{t("pages.allowed_html_tags")}</p>
                      <div className="flex flex-wrap gap-1">
                  ...
                  {rule.examples &&
              <div>
                      <p className="text-xs font-medium text-gray-500 mb-1">{t("pages.examples")}</p>
                ...
                <div className="flex items-center justify-between pt-3 border-t">
                  ...
                  onChange={(e) => updateRule(rule.id, { enabled: e.target.checked })} />
                    ...
                    <span className="text-sm">{t("components.enabled")}</span>
                  </label>
                  <div className="flex items-center space-x-2">
                    <Button size="sm" variant="secondary">{t("pages.edit_rule")}

                </Button>
                    <Button size="sm" variant="ghost" className="text-red-600">{t("components.delete")}
  ...
  <Card>
      ...
      <div className="overflow-x-auto">
        <table className="min-w-full divide-y divide-gray-200">
          <thead>
            <tr>
              <th className="px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase">{t("pages.time")}</th>
              <th className="px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase">{t("pages.rule")}</th>
              <th className="px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase">{t("pages.action")}</th>
              <th className="px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase">{t("components.user")}</th>
              <th className="px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase">{t("components.input")}</th>
              <th className="px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase">{t("pages.result")}</th>
            </tr>
          </thead>
          <tbody className="divide-y divide-gray-200">
            <tr>
              <td className="px-4 py-3 text-sm">{t("pages.20230516_103045")}</td>
              <td className="px-4 py-3 text-sm">{t("pages.sql_injection_prevention")}</td>
              <td className="px-4 py-3 text-sm">{t("pages.login_attempt")}</td>
              <td className="px-4 py-3 text-sm">{t("pages.anonymous")}</td>
              <td className="px-4 py-3 text-sm font-mono">{t("pages.admin_or_11")}</td>
              <td className="px-4 py-3">
                <span className="inline-flex items-center px-2 py-1 rounded-full text-xs font-medium bg-red-100 text-red-800">{t("components.blocked")}

              </span>
              </td>
            </tr>
            <tr>
              <td className="px-4 py-3 text-sm">{t("pages.20230516_102512")}</td>
              <td className="px-4 py-3 text-sm">Email Validation</td>
              <td className="px-4 py-3 text-sm">{t("pages.registration")}</td>
            ...
            <tr>
              <td className="px-4 py-3 text-sm">{t("pages.20230516_102034")}</td>
              <td className="px-4 py-3 text-sm">File Extension Validation</td>
              <td className="px-4 py-3 text-sm">{t("pages.upload")}</td>
              <td className="px-4 py-3 text-sm">jane_smith</td>
              <td className="px-4 py-3 text-sm font-mono">{t("pages.documentpdf")}</td>
              <td className="px-4 py-3">
                <span className="inline-flex items-center px-2 py-1 rounded-full text-xs font-medium bg-green-100 text-green-800">{t("pages.allowed")}
...
def register():
    ...
    # Continue with registration...`)}>
              ...
              <Copy className="w-4 h-4 mr-2" />{t("pages.copy_code")}
  ...
  return (
    <form onSubmit={handleSubmit}>
      ...
      <button type="submit">Register</button>
          ...
          <div>
            <h4 className="font-medium mb-2">{t("pages.sql_injection_prevention")}</h4>
            <pre className="bg-gray-50 p-4 rounded-lg overflow-x-auto">
...
result = db.execute(query, {"username": username, "password": password})`}</code>
      ...
      <Card>
        <h3 className="font-semibold text-lg mb-4">{t("pages.best_practices")}</h3>
        <ul className="space-y-3">
          ...
          <li className="flex items-start space-x-2">
            <CheckCircle className="w-5 h-5 text-green-500 mt-0.5" />
            <div>
              <p className="font-medium">{t("pages.use_whitelist_approach_over_blacklist")}</p>
          ...
          <li className="flex items-start space-x-2">
            <CheckCircle className="w-5 h-5 text-green-500 mt-0.5" />
            <div>
              <p className="font-medium">{t("pages.sanitize_all_user_input")}</p>
              <p className="text-sm text-gray-600">{t("pages.never_trust_user_input_always_escape_or_sanitize")}</p>
            </div>
          </li>
          <li className="flex items-start space-x-2">
            <CheckCircle className="w-5 h-5 text-green-500 mt-0.5" />
            <div>
              <p className="font-medium">{t("pages.use_prepared_statements_for_database_queries")}</p>
              <p className="text-sm text-gray-600">{t("pages.prevents_sql_injection_attacks")}</p>
            </div>
          </li>
          <li className="flex items-start space-x-2">
            <CheckCircle className="w-5 h-5 text-green-500 mt-0.5" />
            <div>
              <p className="font-medium">{t("pages.implement_rate_limiting")}</p>
              <p className="text-sm text-gray-600">{t("pages.prevent_brute_force_and_dos_attacks")}</p>
            </div>
          </li>
        </ul>
      </Card>
  ...
  <div className="fixed inset-0 bg-black/50 flex items-center justify-center p-4 z-50">
        <Card className="max-w-2xl w-full max-h-[80vh] overflow-y-auto">
          ...
          <div className="space-y-4">
            ...
            <div>
              <p className="font-medium mb-1">{t("components.category")}</p>
              <p className="text-sm">{selectedRule.category}</p>
            </div>
            <div>
              <p className="font-medium mb-1">{t("components.severity")}</p>
        ...
        <div>
                <p className="font-medium mb-1">{t("pages.patternregex")}</p>
        ...
        <div>
                <p className="font-medium mb-1">{t("pages.examples")}</p>
            ...
            <div className="pt-4 border-t">
              <Button
            onClick={() => setSelectedRule(null)}
            variant="secondary">{t("components.close")}
