...
const SecurityHeadersPage = () => {
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        ...
        <Card>
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm text-gray-600">Active Headers</p>
        ...
        <Card>
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm text-gray-600">Missing Headers</p>
              <p className="text-2xl font-bold">
  ...
  const renderConfiguration = () => (
    <div className="space-y-6">
      <Card>
        <h3 className="font-semibold text-lg mb-4">Header Configuration</h3>
        <div className="space-y-4">
          {securityHeaders.map(header => (
            <div key={header.name} className="border rounded-lg p-4">
              ...
              <div className="space-y-2">
                ...
                <div className="flex justify-between items-center">
                  <Button
                    size="sm"
                    variant="secondary"
                    onClick={() => updateHeaderConfig(header.name, header.recommended)}
                  >
                    Use Recommended
                  </Button>
                  <Button
  ...
  const renderTestResults = () => (
    <div className="space-y-6">
      {testResults ? (
        <>
          <Card>
            <h3 className="font-semibold text-lg mb-4">Latest Security Test Results</h3>
            <div className="space-y-4">
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  <p className="text-sm text-gray-600">URL Tested</p>
        ...
        <Card>
          <div className="text-center py-12">
            ...
            <p className="text-gray-600">No security test results available</p>
            <Button
              onClick={() => testHeaders()}
              className="mt-4"
              disabled={loading}
